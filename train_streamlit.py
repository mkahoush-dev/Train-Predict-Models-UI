                                                        ...
                                                        if save_condition in ("train acc","val acc"):
                                                            st.write("Saved model {} as {} increased from 0 to {}."\
                                                                     .format(save_model+".h5", save_condition,
                                                                             np.round(train_acc,3) if save_condition == "train acc" else np.round(val_acc,3)))
                                                        else:
                                                            st.write("Saved model {} as {} decreased from infinite to {}."\
                                                                     .format(save_model+".h5", save_condition,
                                                                             np.round(train_loss,3) if save_condition == "train loss" else np.round(val_loss,3)))
                                                    else:
                                                        if save_condition == "train acc":
                                                            if train_acc >= best_train_acc:
                                                                ...
                                                                st.write("Saved model {} as {} increased from {} to {}."\
                                                                     .format(save_model+".h5", save_condition,
                                                                             np.round(best_train_acc,3),np.round(train_acc,3)))
                                                                best_train_acc = train_acc
                                                            else:
                                                                st.write("Not saving model as {} did not increase from {}."\
                                                                     .format(save_condition, np.round(best_train_acc,3)))
                                                            ...
                                                            if val_acc >= best_val_acc:
                                                                ...
                                                                st.write("Saved model {} as {} increased from {} to {}."\
                                                                     .format(save_model+".h5", save_condition,
                                                                             np.round(best_val_acc,3),np.round(val_acc,3)))
                                                                best_val_acc = val_acc
                                                            else:
                                                                st.write("Not saving model as {} did not increase from {}."\
                                                                     .format(save_condition, np.round(best_val_acc,3)))
                                                            ...
                                                            if train_loss >= best_train_loss:
                                                                ...
                                                                st.write("Saved model {} as {} decreased from {} to {}."\
                                                                     .format(save_model+".h5", save_condition,
                                                                             np.round(best_train_loss,3),np.round(train_loss,3)))
                                                                best_train_loss = train_loss
                                                            else:
                                                                st.write("Not saving model as {} did not increase from {}."\
                                                                     .format(save_condition, np.round(best_train_loss,3)))
                                                            ...
                                                            if val_loss >= best_val_loss:
                                                                ...
                                                                st.write("Saved model {} as {} decreased from {} to {}."\
                                                                     .format(save_model+".h5", save_condition,
                                                                             np.round(best_val_loss,3),np.round(val_loss,3)))
                                                                best_val_loss = val_loss
                                                            else:
                                                                st.write("Not saving model as {} did not increase from {}."\
                                                                     .format(save_condition, np.round(best_val_loss,3)))
